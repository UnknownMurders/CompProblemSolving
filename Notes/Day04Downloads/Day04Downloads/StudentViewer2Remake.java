...
public class StudentViewer2Remake extends Application implements EventHandler<ActionEvent> 
{
   ...
   public void start(Stage _stage) throws Exception 
   {
      ...
      stage.setTitle("Student Viewer 2 RILEY");            // set the text in the title bar
      ...
      semirootTwo.addRow(0, lblName, tfName);
      semirootTwo.addRow(1, lblID, tfID);
      semirootTwo.addRow(2, lblGPA, tfGPA);
      semirootTwo.setAlignment(Pos.CENTER);
      
      
      semirootThree.addRow(0, btnNext, btnExit);
