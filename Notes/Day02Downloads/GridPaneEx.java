...
public class GridPaneEx extends Application implements EventHandler<ActionEvent> 
{
   ...
   public void start(Stage _stage) throws Exception 
   {
      ...
      stage.setTitle("HBox Example");            // set the text in the title bar
      tfID.setPrefColumnCount(6);
      tfGPA.setPrefColumnCount(4);
      
      root.addRow(0, lblName, tfName);
      root.addRow(1, new Label(""), lblID, tfID);
      root.addRow(2, lblGPA, tfGPA);
            
      scene = new Scene(root, 300, 100);   // create scene of specified size 
                                             // with given layout
