...
public abstract class TestMyLinkedList extends javafx.application.Application implements javafx.event.EventHandler<ActionEvent>
{
   private Stage stage;
     ...
     throws MyLinkedListException
   {
      ...
      Integer localInteger1; Integer localInteger2; 
      for (; index.intValue() > -1; 
