 ...
 */
 ...
 //This is one way to be able to run a program
public class FirstThread extends Application implements EventHandler<ActionEvent> {
   // Window attributes
   private Stage stage;
   private Scene scene;
   ...
   public void start(Stage _stage) {
      ...
      Thread timerThread = new TimerThread(tfTimer);
      timerThread.start();
